...
def update_intrusion(db: Session, intrusion_id: int, updated_intrusion: schemas.IntrusionBase, new_property_id: int | None = None):
...
def delete_intrusion(db: Session, intrusion_id):
